...
const CardProductLanding: React.FC<CardProductLandingProps> = ({
  ...
  return (
    ...
    >
      <div
        className="card-landing-productos"
      ...
      >
        ...
        <div className="card-body-landing-productos">
            ...
            <p className="card-text-landing price-landing">
              ...
              {product.price > 50 && (
                <span className="additional-text-landing">
                  Mismo precio en 3 cuotas de 311 pesos con 67 centavos $31.1,67{" "}
                  <br />
          ...
          <h6 className="card-description-landing">{product.description}</h6>
